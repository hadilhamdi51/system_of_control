...
<body>
						...
						<div class=" d-flex">
							<div class="card flex-fill">
								<div class="card-header mt-9">
									...
									<h5 class="card-title mb-0">List Of Histories</h5>
								</div>
  ...
  <div class="md-card-content"style="overflow-x: auto;" >
								<table   >
									<thead >
										<tr >
											...
											<th class="d-none d-xl-table-cell">Acces</th>
											<th class="d-none d-xl-table-cell">Classroom</th>
		...
		<th  scope="row">{{ $subject->id }}</th>
            ...
            <td >{{$subject->card_id }}</td>
			<td >{{$subject->Access }}</td>
            <td >{{$subject->classroom}}</td>
			
            <td>{{ Str::substr($subject->created_at, 0, 30).'...' }}</td>
			<td>{{ Str::substr($subject->updated_at, 0, 30).'...' }}</td>
